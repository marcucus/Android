...
public class FrActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Global.changeAfficheDate((DatePicker) findViewById(R.id.datFr), false) ;
	...
	private void valoriseProprietes() {
		annee = ((DatePicker)findViewById(R.id.datFr)).getYear() ;
		mois = ((DatePicker)findViewById(R.id.datFr)).getMonth() + 1 ;
    ...
    private void imgReturn_clic() {
    	findViewById(R.id.imgFrReturn).setOnClickListener(new ImageView.OnClickListener() {
    ...
    private void cmdValider_clic() {
    	findViewById(R.id.cmdFrValider).setOnClickListener(new Button.OnClickListener() {
    		public void onClick(View v) {
    			Serializer.serialize(Global.listFraisMois, FrActivity.this) ;
    			retourActivityPrincipale() ;    		
    		}
    	}) ;    	
    }
    ...
    private void dat_clic() {   	
    	final DatePicker uneDate = (DatePicker) findViewById(R.id.datFr);
	...
	private void retourActivityPrincipale() {
		Intent intent = new Intent(FrActivity.this, MainActivity.class) ;
