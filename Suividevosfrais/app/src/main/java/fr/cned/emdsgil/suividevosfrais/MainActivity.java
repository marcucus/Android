...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cmdMenu_clic(((ImageButton) findViewById(R.id.cmdRepas)), FrActivity.class);
        cmdMenu_clic(((ImageButton) findViewById(R.id.cmdNuitee)), FnActivity.class);
        cmdMenu_clic(((ImageButton) findViewById(R.id.cmdEtape)), FeActivity.class);
